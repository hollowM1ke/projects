...
public class Enemy {
    ...
    public Enemy(int newX, int newY, int[][] newLevel){
        ...
        xOrigin = newX;
        yOrigin = newY;
        enemyHappy = new ImageIcon(getClass().getClassLoader().getResource("images/phantom-blue36px.png")).getImage();
        enemyScared = new ImageIcon(getClass().getClassLoader().getResource("images/ghost-scared.png")).getImage();
